...
plt.plot(dim_times, solid_fraction_history, linewidth=1.5, label=r"$f_l(t)$")

plt.xlabel(r"Безразмерное время $\tau = Fo \cdot Ste$")
plt.ylabel(r"Доля воды")
plt.title("Изменение доли воды")
plt.grid(True, alpha=0.3)
plt.legend()
plt.tight_layout()
plt.savefig("./graphs/liquid_fraction/freezing.png", dpi=300)
